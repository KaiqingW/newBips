...
export class BackupComponent implements OnInit{
    ...
    getAdminVendorList(){
        this.vrmService.getAdminList(this.currentLoginCompanyId,'backup').subscribe(
            res=>{
                this.backupVendorList = res.data;
                this.totalNumber = res.paging.total;
                this.unreadAssignNumber = res.paging.unreadAssignCount;
            ...
            this.vrmService.getVendorListNext(this.next).subscribe(
                res =>{
                    ...
                    for (var i = 0; i< this.moreVendorList.length; i++){
                        this.backupVendorList.push(this.moreVendorList[i]);
                    }
                    this.next = res.paging.next;
    ...
    getCustomerByFilterValue(value) {
        ...
        if(value == 'CompanyName'){
            this.vrmService.customerFilterByType(this.currentLoginCompanyId, 'backup', 'name', this.inputValue).subscribe(
                res => {
                    this.backupVendorList = res.data;
                    this.totalNumber = res.paging.total;
                    this.next = res.paging.next;
            ...
            this.vrmService.searchCustomerByFieldName(this.currentLoginCompanyId, 'backup', this.inputValue, 'description').subscribe(
                res=>{
                    this.router.navigate([`/company/${this.currentLoginCompanyId}/vrm/backup-vendor`,{type: 'Description', value:this.inputValue}]);
                    this.backupVendorList = res.data;
                    this.totalNumber = res.paging.total;
                    this.next = res.paging.next;
                    this.isLoading = false;
            ...
            this.vrmService.searchCustomerByFieldName(this.currentLoginCompanyId, 'backup', this.inputValue, 'website').subscribe(
                res=>{
                    this.router.navigate([`/company/${this.currentLoginCompanyId}/vrm/backup-vendor`,{type: 'Website', value:this.inputValue}]);
                    this.backupVendorList = res.data;
                    this.totalNumber = res.paging.total;
                    this.next = res.paging.next;
                    this.isLoading = false;
            ...
            this.vrmService.searchCustomerByFieldName(this.currentLoginCompanyId, 'backup', this.inputValue, 'industry').subscribe(
                res=>{
                    this.router.navigate([`/company/${this.currentLoginCompanyId}/vrm/backup-vendor`,{type: 'Industry', value:this.inputValue}]);
                    this.backupVendorList = res.data;
                    this.totalNumber = res.paging.total;
                    this.next = res.paging.next;
                    this.isLoading = false;
            ...
            this.vrmService.searchCustomerByFieldName(this.currentLoginCompanyId, 'backup', this.inputValue, 'email').subscribe(
                res=>{
                    this.router.navigate([`/company/${this.currentLoginCompanyId}/vrm/backup-vendor`,{type: 'CompanyEmail', value:this.inputValue}]);
                    this.backupVendorList = res.data;
                    this.totalNumber = res.paging.total;
                    this.next = res.paging.next;
                    this.isLoading = false;
            ...
            this.vrmService.searchCustomerByFieldName(this.currentLoginCompanyId, 'main', this.inputValue, 'memo').subscribe(
                res=>{
                    this.router.navigate([`/company/${this.currentLoginCompanyId}/vrm/backup-vendor`,{type: 'Memo', value:this.inputValue}]);
                    this.backupVendorList = res.data;
                    this.totalNumber = res.paging.total;
                    this.next = res.paging.next;
                    this.isLoading = false;
    ...
    searchCustomerByEmployeeName(value){
        ...
        this.vrmService.getCustomerByEmployeeName(this.currentLoginCompanyId, 'backup', value).subscribe(
            res=>{
                this.backupVendorList= res.data;
                this.totalNumber = res.paging.total;
                this.next = res.paging.next;
