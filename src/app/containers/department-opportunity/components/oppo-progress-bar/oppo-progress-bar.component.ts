...
@Component({
  selector: 'oppo-progress-bar',
  templateUrl: './oppo-progress-bar.component.html',
  styleUrls: ['./oppo-progress-bar.component.scss']
})
export class OppoProgressBarComponent implements OnInit {

  @Input() customer_id;
  @Input() completedOpportunityAmount;
  @Input() totalRequiredOpportunityAmount;
  ...
  ngOnInit(){
      ...
      this.possibility = this.completedOpportunityAmount / this.totalRequiredOpportunityAmount;  
