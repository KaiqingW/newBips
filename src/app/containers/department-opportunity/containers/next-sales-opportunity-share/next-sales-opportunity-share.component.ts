...
@Component({
  selector: 'next-sales-opportunity-share',
  templateUrl: './next-sales-opportunity-share.component.html',
  styleUrls: ['./next-sales-opportunity-share.component.scss']
})
export class NextSalesOpportunityShareComponent implements OnInit {
