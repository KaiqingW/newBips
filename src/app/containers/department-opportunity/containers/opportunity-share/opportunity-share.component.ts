...
@Component({
  selector: 'opportunity-share',
  templateUrl: './opportunity-share.component.html',
  styleUrls: ['./opportunity-share.component.scss']
})
export class OpportunityShareComponent implements OnInit {
