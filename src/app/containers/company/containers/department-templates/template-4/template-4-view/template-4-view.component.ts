...
@Component({
    selector: 'template-4-view',
    templateUrl: './template-4-view.component.html',
    styleUrls: ['./template-4-view.component.scss'],
})

export class Template4ViewComponent implements OnInit, OnChanges {
    @Input() row;
