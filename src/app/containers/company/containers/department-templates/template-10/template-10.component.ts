...
@Component({
    selector: 'template-10',
    templateUrl: './template-10.component.html',
    styleUrls: ['./template-10.component.scss'],
})

export class Template10Component implements OnInit, OnChanges {
    @Input() row;
