...
@Component({
  selector: 'opportunity-attachment',
  templateUrl: './opportunity-attachment.component.html',
  styleUrls: ['./opportunity-attachment.component.scss']
})
export class OpportunityAttachmentComponent implements OnInit {

  @Input() title: string;
  @Input() attachments: any;
  @Input() canUpload: boolean;
  @Input() prevProjectId: any;
  ...
  addAttachementDialog() {
    const dialogRef = this.dialog.open(AddAttachmentComponent, {
      ...
      data: {
        ...
        prevProjectId: this.prevProjectId,
